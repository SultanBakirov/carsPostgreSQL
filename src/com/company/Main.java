...
SELECT * FROM cars WHERE color IN ('Red', 'Blue') ORDER BY color;

SELECT * FROM cars WHERE year_of_issue BETWEEN 2000 AND 2010 ORDER BY year_of_issue;

SELECT COUNT(brand) FROM cars WHERE brand = 'Chevrolet';

SELECT AVG(year_of_issue) AS average_year_of_issue FROM cars;

SELECT * FROM cars WHERE brand IN ('Audi', 'Toyota', 'Kia', 'Ford') ORDER BY brand;
...
SELECT SUM(price) AS sum_of_mercedesBenz FROM cars WHERE brand = 'Mercedes-Benz';

SELECT MAX(price) FROM cars; SELECT MIN(price) FROM cars;

SELECT * FROM cars WHERE brand <> 'Toyota' ORDER BY brand;

SELECT * FROM cars ORDER BY price DESC LIMIT 10;

SELECT * FROM cars ORDER BY year_of_issue DESC OFFSET 5 ROWS FETCH NEXT 15 ROWS ONLY;

SELECT * FROM cars WHERE year_of_issue NOT BETWEEN 1995 AND 2005 ORDER BY year_of_issue;

SELECT color, COUNT(*) AS count_of_cars FROM cars GROUP BY color ORDER BY count_of_cars DESC;
    }
}
